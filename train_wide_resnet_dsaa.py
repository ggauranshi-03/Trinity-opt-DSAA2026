...
def main():
    ...
    csv_path = os.path.join(args.output_dir, f"wideresnet_{args.dataset}_imb{args.imb_factor}.csv")
    ...
    run = wandb.init(project="Trinity-Benchmark", name=f"WideResNet_{args.dataset}_imb{args.imb_factor}", config=args)
