...
\cmidrule(lr){2-3}\cmidrule(lr){4-5}
  ...
  & \textbf{Acc.} & \textbf{Time\,(s)} \\
\midrule
SGD (Nesterov)      & \textbf{66.17\%} & 414 & 56.52\% & 233 \\
RMSProp             & 59.68\% & 382 & 57.46\% & 234 \\
Adam                & 61.79\% & 385 & 59.25\% & 230 \\
\textbf{Trinity}    & 63.07\% & 487 & \textbf{62.96\%} & 312 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
RMSProp             & 61.46\% & 965  \\
SGD (Nesterov)      & \textbf{63.82\%} & 946  \\
\textbf{Trinity}    & 61.38\% & 1583 \\
Adam                & 62.25\% & 969  \\
\bottomrule
\end{tabular}
\end{table}
...
In \textbf{Experiment 1} (Figure \ref{fig:exp1}), training the massive Wide-ResNet architecture from scratch on severely imbalanced data shows that SGD achieves the highest peak accuracy of 66.17\%. Trinity reaches a competitive peak accuracy of 63.07\%, outperforming both Adam (61.79\%) and RMSProp (59.68\%). 
...
In \textbf{Experiment 3} (Figure \ref{fig:exp3}), the compact ResNet-18 backbone yields a different optimization dynamic. Here, SGD achieves the highest accuracy at 63.82\%, followed by Adam at 62.25\% and RMSProp at 61.46\%. Trinity reaches 61.38\%, indicating that for lower-capacity models trained on highly constrained datasets, the aggressive structural preconditioning acts as a heavy regularizer. While this prevents overfitting, it can slightly limit peak validation accuracy compared to unconstrained adaptive tracking.
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    ...
    \addplot[
      ...
      color=colorhybrid,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp1_hybrid.csv};
    ...
    \addplot[
      ...
      color=coloradam,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp1_adam.csv};
    \addlegendentry{Adam}
    ...
    \addplot[
      ...
      color=colorrmsprop,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp1_rmsprop.csv};
    ...
    \addplot[
      ...
      color=colorsgd,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp1_sgd.csv};
    \addlegendentry{SGD}
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    ...
    \addplot[
      ...
      color=colorhybrid,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp2_hybrid.csv};
    \addlegendentry{Trinity}
    ...
    \addplot[
      ...
      color=coloradam,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp2_adam.csv};
    \addlegendentry{Adam}
    ...
    \addplot[
      ...
      color=colorrmsprop,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp2_rmsprop.csv};
    \addlegendentry{RMSProp}
    ...
    \addplot[
      ...
      color=colorsgd,
      mark=none,
    ] table[x=epoch, y=val_acc, col sep=comma] {extra/baseline_experiments/exp2_sgd.csv};
    \addlegendentry{SGD}
...
\begin{figure}[t]
  ...
  legend columns=4,
    ...
    \addplot[
      ...
      {extra/baseline_experiments/exp3_hybrid.csv};
    \addlegendentry{Trinity}
    ...
    \addplot[
      ...
      {extra/baseline_experiments/exp3_adam.csv};
    \addlegendentry{Adam}
    ...
    \addplot[
      ...
      {extra/baseline_experiments/exp3_rmsprop.csv};
    \addlegendentry{RMSProp}
    ...
    \addplot[
      ...
      {extra/baseline_experiments/exp3_sgd.csv};
    \addlegendentry{SGD}
