...
The primary reason this curvature anisotropy---the directional ill-conditioning where the loss landscape curves sharply along certain parameter directions while remaining nearly flat along others---remains unmeasured is that traditional diagnostics require Hessian-vector products or full eigendecompositions. These operations are typically as expensive as the preconditioning step they are meant to evaluate, making them impractical for dynamic runtime control.
